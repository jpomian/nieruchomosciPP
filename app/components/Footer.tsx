    ...
    return (
        <footer className="bg-gray-100 py-8">
            <div className="max-w-screen-xl mx-auto px-4">
                ...
                <div className="flex justify-center text-gray-500 text-sm pt-2">
                    Twórcą strony jest&nbsp;
                    <Terminal size={16} className="mt-1" /> <a href="https://github.com/jpomian" className='anchor'>Jędrzej Pomianowski</a>.
