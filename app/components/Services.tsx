...
import { Briefcase, Users, Star, Zap, BarChart, Lock } from 'lucide-react'

type Role = 'Agent' | 'Pro'

type RoleName = 'Agent Nieruchomości' | 'Rzeczoznawca Majątkowy'
...
export default function DynamicServicesSection() {
  ...
  return (
    <section id="services" className="min-h-1/2 bg-background flex flex-col justify-center items-center p-6 relative overflow-hidden">
