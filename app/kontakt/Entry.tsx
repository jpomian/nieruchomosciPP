export default function CTAContact() {
  return (
    <section className="w-full py-16 md:py-16 lg:py-24">
        ...
        <div className="absolute top-1/4 left-1/4 w-48 h-48 bg-amber-200/50 rounded-full blur-2xl"></div>
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-green-500/20 rounded-full blur-xl"></div>
        <div className="absolute top-3/4 left-1/2 w-32 h-32 bg-gray-600/10 rounded-full blur-2xl"></div>
        <div className="absolute bottom-1/2 right-1/3 w-72 h-72 bg-green-600/10 rounded-full blur-2xl"></div>
      </div>
      <div className="container px-4 md:px-6 mx-auto">
        <div className="flex flex-col items-center space-y-8 text-center">
          <h2 className="text-2xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-sky-900">
