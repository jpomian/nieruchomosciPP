...
export default function CTAContact() {
  return (
    <section className="w-full py-24 md:py-24 lg:py-32 bg-gradient-to-b from-sky-200 to-white">
      ...
      <div className="container px-4 md:px-6 mx-auto">
        <div className="flex flex-col items-center space-y-8 text-center">
          ...
          <p className="max-w-[600px] text-sky-800 md:text-xl dark:text-sky-200">
            Napisz do mnie maila, zadzwoń lub wypełnij formularz, a z pewnością się do Ciebie odezwę.
          </p>
          <div className="">
          <Link
            href="#formularz"
            className="inline-flex h-11 items-center justify-center rounded-md bg-sky-600 px-8 text-sm font-medium text-white transition-colors hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-sky-400 focus:ring-offset-2 group"
          >
            Wypełnij formularz
